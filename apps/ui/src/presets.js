export const PRESETS = [
  {
    ...
    description: 'Project workflow default (plan -> next step -> checklist)',
  ...
  },
  {
    ...
    description: 'Feature/bug code workflow with file/test focus',
    systemPromptTemplate:
  ...
  },
  {
    ...
    description: 'Khronika project flow (Next.js + Supabase + RLS)',
    systemPromptTemplate:
